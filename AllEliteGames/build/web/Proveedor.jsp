    ...
    <body>
        <div class="container-fluid d-flex justify-content-center align-items-center" style="margin-top: 75px;">
            <div class="row w-100 align-items-stretch" style="max-width: 1600px;"> 
                ...
                <div class="col-md-4">
                    <div class="card shadow-lg" style="height: 510px">
                        <div class="card-body p-3">
                            <form action="Controlador?menu=Proveedor" method="POST" onsubmit="return validarForm()">
                                <div class="form-group">
                                    <label><strong>Nombres: </strong></label>
                                    <input type="text" id="txtNombresProveedor" value="${proveedor.nombresProveedor}"  name="txtNombresProveedor" class="form-control form-control-ls" required>
                                </div>
                                <div class="form-group">
                                    <label><strong>Telefono: </strong></label>
                                    <input type="text" id="txtTelefonoProveedor" value="${proveedor.telefonoProveedor}"   name="txtTelefonoProveedor" class="form-control form-control-ls" required>
                                </div>
                                <div class="form-group">
                                    <label><strong>Correo: </strong></label>
                                    <input type="text" value="${proveedor.correoProveedor}" name="txtCorreoProveedor" class="form-control form-control-ls">
                                </div>
                                <div class="form-group">
                                    <label><strong>Direccion: </strong></label>
                                    <input type="text" value="${proveedor.direccion}" name="txtDireccion" class="form-control form-control-ls">
                                </div>
                                <div class="form-group">
                                    <label><strong>Estado: </strong></label>
                                    <input type="text" value="${proveedor.estado}" name="txtEstado" class="form-control form-control-ls">
                                </div>
                                <div>
