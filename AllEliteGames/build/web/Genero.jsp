                ...
                <div class="card-body p-3">
                    ...
                    <form action="Controlador?menu=genero" method="POST">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="${genero.getGenero()}" name="txtGenero" class="form-control form-control-ls">
                        </div>
                        <div class="form-group mb-3">
                            <label class="fs-6"><strong>Edad Recomendada:</strong></label>
                            <input type="text" value="${genero.getEdadRecomendable()}" name="txtEdadRecomendable" class="form-control form-control-ls">
                        </div>
                        <div class="form-group mb-3">
                            <label class="fs-6"><strong>Popularidad:</strong></label>
                            <input type="text" value="${genero.getPopularidad()}" name="txtPopularidad" class="form-control form-control-ls">
                        </div>
                        <div class="form-group mb-3">
                            <label class="fs-6"><strong>Público Objetivo:</strong></label>
                            <input type="text" value="${genero.getPublicoObjetivo()}" name="txtPublicoObjetivo" class="form-control form-control-ls">
                        </div>
                        <div class="form-group mb-3">
                            <label class="fs-6"><strong>Estado:</strong></label>
                            <input type="text" value="${genero.getEstado()}" name="txtEstado" class="form-control form-control-ls">
                        </div>
